        ...
        >
          <div class="sm:text-center lg:text-left">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
              <span class="block xl:inline">Re-Imagine System Dynamics</span>
              {{ ' ' }}
              <span class="block text-indigo-600 xl:inline">Web Simulations</span>
            </h1>
            <p
              class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0"
            >
              Apply the power of Learning Analytics in Learners Simulations
            </p>
